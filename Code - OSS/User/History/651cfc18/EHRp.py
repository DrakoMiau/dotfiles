    ...
    Screen(
        ...
        top=bar.Bar(
            [
                ...
                widget.TextBox(
                    text=" ", background="#9db3b9", foreground="#191724", padding=7
                ),
                widget.CurrentLayout(background="#9db3b9",
                                     foreground="#191724"),
                widget.TextBox(
                    text="",
                    background="#9db3b9",
                ...
                widget.TextBox(
                    text="󰅐", background="#003139", foreground="#aeafaf", padding=7
                ),
                widget.Clock(
                    background="#003139",
                    foreground="#aeafaf",
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.TextBox(text="", foreground="#e0def4", padding=0, fontsize=42),
                widget.TextBox(
                    text=" ", background="#e0def4", foreground="#191724", padding=2
                ),
                widget.CheckUpdates(
                ...
                widget.TextBox(
                    text="", background="#c4a7e7", foreground="#191724", padding=7
                ),
                widget.Clock(
                    background="#c4a7e7",
                    foreground="#191724",
